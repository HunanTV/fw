...
public class StringUtil {
	...
	for (int i = fromIndex; i <= max; i++) {
		...
		for (int k = 1; j < end
			&& equalsIngoreCase(str.charAt(j), target.charAt(k)); j++, k++) {
		}
    ...
    public static String addMarkIgnoreCase(String str, char r,
    ...
    public static String addMarkIgnoreCase(String str, String r,
	    String beginMark, String endMark) {
