...
public class Dispatcher extends AbstractHandler {
    ...
    public final static Logger logger = LoggerFactory.getLogger(Dispatcher.class);
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("[uri=" + uri + " query=" + queryStr + " cost=" + new Long(etime - btime).toString() + "]");
            SeqIdThreadLocal.clear();
        }
    }
